"""
This dataloader is build upon the code from the gthub repo
https://github.com/gli-27/voca-pytorch/blob/master/utils/audio_loader.py
...
class DataHandler:
    def __init__(self, config, dataset_path):
        ...
        self.num_consecutive_frames = int(config['num_consecutive_frames'])
        print("Loading data")
    ...
    def _load_data(self, dataset_path):
        ...
        face_templates_path = os.path.join(dataset_path, "templates.pkl")
        raw_audio_path = os.path.join(dataset_path, "raw_audio_fixed.pkl")
        processed_audio_path = os.path.join(dataset_path, "processed_audio_deepspeech.pkl")
        data2array_verts_path = os.path.join(dataset_path, "subj_seq_to_idx.pkl")
